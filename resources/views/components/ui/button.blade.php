...
@php
    $classes = "inline-flex justify-center items-center rounded-full px-6 py-3 font-semibold text-sm transition focus:outline-none focus:ring-2 focus:ring-offset-2";
