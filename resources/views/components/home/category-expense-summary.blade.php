...
<div class="bg-background rounded-2xl p-5 shadow-sm border border-gray-200 mb-6">
        ...
        @forelse ($expenses as $exp)
            <div>
                ...
                <div x-data="{
                    ...
                    <span :style="'width:' + progress + '%'" class="absolute h-full duration-300 ease-linear bg-danger"
                        x-cloak></span>
                </div>
            </div>
        @empty
