        ...
        <div class="space-y-6">
            ...
            <div>
                <div class="flex justify-between items-end mb-3">
                    <h3 class="text-sm font-medium text-gray-700">Senin, 16 Nov 2026</h3>
                    <span class="text-sm font-medium text-gray-900">- Rp 100.000</span>
                </div>
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <x-transaction.card nama="Makan Siang" kategori="Food" nominal="50000" tipe="pengeluaran"
                        jam="12.00" />
                    <x-transaction.card nama="Belanja" kategori="Groceries" nominal="50000" tipe="pengeluaran"
                        jam="13.06" />
                </div>
            </div>
            ...
            <div>
                <div class="flex justify-between items-end mb-3">
                    <h3 class="text-sm font-medium text-gray-700">Minggu, 15 Nov 2026</h3>
                    <span class="text-sm font-medium text-gray-900">- Rp 100.000</span>
                </div>
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <x-transaction.card nama="Makan Siang" kategori="Food" nominal="50000" tipe="pengeluaran"
