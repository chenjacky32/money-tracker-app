<x-guest-layout>
    ...
    <div class="px-6 py-5 bg-background flex items-center gap-6 sticky top-0 z-40">
        ...
        <h2 class="text-2xl font-bold text-gray-deep">Edit Transaksi</h2>
    </div>
        ...
        <form class="space-y-6">
            ...
            <div class="text-center mb-8">
                ...
                <div class="flex items-center justify-center gap-2 border-b border-gray-300 pb-2 mx-8">
                    ...
                    <input type="number" class="w-40 text-center bg-transparent border-none text-4xl font-bold text-primary p-0 focus:ring-0" placeholder="0" value="50000">
                </div>
            </div>
            ...
            <div class="bg-white rounded-[20px] border border-gray-200 p-4 mt-6 shadow-sm flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-base text-gray-deep">Senin, 16 Nov 2026</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-[20px] border border-gray-200 p-4 mt-4 shadow-sm flex items-center gap-4">
                ...
                <div class="w-full">
                    ...
                    <input type="text" class="w-full border-none p-0 text-base focus:ring-0 bg-transparent placeholder-gray-light" value="Makan Siang Klien">
                </div>
            </div>
            ...
            <div class="pt-8 pb-12 flex gap-4">
                ...
                <button type="button" class="flex-1 bg-primary text-white rounded-[20px] py-4 text-base font-bold shadow-md hover:bg-primary/90 transition flex items-center justify-center gap-2">
