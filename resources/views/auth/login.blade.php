    ...
    <div class="px-6 py-12 flex flex-col min-h-screen bg-white">
        <div class="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
            <div class="mb-10 text-center">
                <div class="w-14 h-14 bg-[#F2F4F3] border border-gray-200 rounded-2xl flex items-center justify-center mx-auto mb-6">
                </div>
            ...
            <form class="space-y-5">
                ...
                <div class="flex items-center justify-between pt-1">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary/20 bg-[#F8FAF9]">
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full bg-primary text-white rounded-xl py-3.5 font-bold text-[15px] hover:bg-primary/90 transition shadow-sm">
                        Sign In
                    </button>
                </div>
            </form>
            ...
            <button type="button" class="w-full bg-[#F8FAF9] border border-gray-200 text-gray-800 rounded-xl py-3.5 font-medium text-[15px] hover:bg-gray-100 transition flex items-center justify-center gap-3">
