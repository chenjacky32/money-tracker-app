                ...
                <div class="flex items-center justify-between pt-1">
                    <label for="remember_me" class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" id="remember_me" name="remember" {{ old('remember') ? 'checked' : '' }}
                            class="w-4 h-4 rounded border-gray-300 text-primary checked:bg-primary checked:border-primary focus:ring-primary/20 bg-gray-soft transition-colors duration-200 cursor-pointer">
